...
# ligandInfo,mean_GCaMP,pumps=NULL,exportXLSX=NULL,windowBefore=5,windowAfter=0,voltage=5,matchByTime=FALSE

#' Run normalisation of reponse values
#'
#' Run normalisation of reponse values as descibed in Jove et al 2020.
#'
#'
#' @name  vnorm
#' @rdname vnorm
